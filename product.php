            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <span onclick="click_open(1)" class="btn btn-primary btn-sm pull-right mx-2">Add Product
                ...
                <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">  
                        ...
                        <tbody>
                            <?php $result = select('products','*','dll=0');
                            ...
                            <tr>
                                ...
                                <th><small>Rs.</small> <?php echo $row['price']  ?></th>
                                <th>
