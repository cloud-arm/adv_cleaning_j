...
<?php echo $name = $row['name']; ?>
                                    ...
                                    <li class="list-group-item">
                                        <b>Day Rate:</b> <i><?php echo $rate = $row['rate']; ?></i>
                                    </li>
                                    <li class="list-group-item">
                            ...
                            <div class="active tab-pane" id="settings">
                                <form method="post" action="hr_employee_save.php" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="row" style="margin-right: 10px;">
                                        ...
                                        <div class="form-group">
                                            <label or="" class="col-sm-2 control-label">Salary Type</label>
                                            <div class="col-sm-10">

                                            <select class="form-control select2 hidden-search"  name="Sal_type" value="<?php echo $Sal_type; ?>" id="">
                                                <option <?php if ($sal_type == 'daily') { ?> selected <?php } ?> value="daily">Daily</option>
                                                <option <?php if ($sal_type == 'weekly') { ?> selected <?php } ?> value="weekly">Weekly</option>
                                                <option <?php if ($sal_type == 'monthly') { ?> selected <?php } ?> value="monthly">Mounthly</option>
                                            </div>
                                            </select>
                                        </div>
                                     </div>
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Special OT rate</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="well" value="<?php echo $s_ot_rate; ?>"  placeholder="S: OT " autocomplete="off">
