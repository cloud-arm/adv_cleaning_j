                ...
                <table id="" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $nic ?></td>
                            <td><?php echo $id ?></td>
                            <td><?php echo $tot=$epf+$epf/8*12; $total+= $tot;?>.00</td>
                            <td><?php echo $epf_12=$epf/8*12; $epf_12_tot+=$epf_12; ?>.00</td>
                            <td><?php echo $epf; $epf_8_tot+=$epf;  ?></td>
                    ...
                    <tbody style="border-top: 0;">
                      <tr>
                          ...
                          <td><h4><?php echo $epf_12_tot; ?>.00</h4></td>
                          <td><h4><?php echo $epf_8_tot; ?>.00</h4></td>
                          <td></td>
                        </tr>
                    </tbody>
                </table>
